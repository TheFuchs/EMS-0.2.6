...
private ["_aiunit","_wp","_xpos","_ypos","_unitpos","_aiGroup","_levelnum","_numunits","_rndLOut","_ailoadout","_aispawnpos","_aiwep1","_aiammo1","_aiwep2","_aiammo2"];
    ...
    for [{ x=1 },{ x < _numunits+1 },{ x = x + 1; }] do
    {
      ...
      //add some garbage
        ...
        //set skills
        _aiunit setSkill ["aimingAccuracy",0.7];
    ...
    _wppos = [_xpos+(x*120),_ypos+(x*120),_wpradius];
