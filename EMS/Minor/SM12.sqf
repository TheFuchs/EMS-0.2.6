...
_coords = [getMarkerPos "center",0,6000,10,0,2000,0] call BIS_fnc_findSafePos;
...
if (_playerPresent) then {
	...
	[nil,nil,rTitleText,"Survivors secured the crash site!", "PLAIN",6] call RE;
	[nil,nil,rGlobalRadio,"Survivors secured the crash site!"] call RE;
	[nil,nil,rHINT,"Survivors secured the crash site!"] call RE;
} else {
	deleteVehicle _uralcrash;
	[nil,nil,rTitleText,"Survivors missed securing the loot!", "PLAIN",6] call RE;
	[nil,nil,rGlobalRadio,"Survivors missed securing the loot!"] call RE;
	[nil,nil,rHINT,"Survivors missed securing the loot!"] call RE;
};
