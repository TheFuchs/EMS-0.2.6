...
_coords = [getMarkerPos "center",0,3200,2,0,20,0] call BIS_fnc_findSafePos;
...
_hummer = createVehicle ["UAZ_Unarmed_DZE",[(_coords select 0) + 10, (_coords select 1) - 5,0],[], 0, "CAN_COLLIDE"];
...
if (_playerPresent) then {
	...
	[nil,nil,rHINT,"The party has finished the hunt!"] call RE;
};
