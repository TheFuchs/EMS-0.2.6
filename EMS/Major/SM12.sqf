...
if (_playerPresent) then {
	...
	[nil,nil,rTitleText,"Bandits have secured the APC!", "PLAIN",6] call RE;
	[nil,nil,rGlobalRadio,"Bandits have secured the APC!"] call RE;
	[nil,nil,rHINT,"Bandits have secured the APC!"] call RE;
};
