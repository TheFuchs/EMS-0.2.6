...
MissionGoName = "Helicopter Crash";
...
_chopper = ["AH64D_EP1","CH_47F_EP1_DZE"] call BIS_fnc_selectRandom;
...
if (_playerPresent) then {
	waitUntil{{isPlayer _x && _x distance _hueychop < 20  } count playableunits > 0}; 
	...
	[nil,nil,rTitleText,"Bandits have secure the helicopter!", "PLAIN",6] call RE;
	[nil,nil,rGlobalRadio,"Bandits have cleared the helicopter!"] call RE;
	[nil,nil,rHINT,"Bandits have cleared the helicopter!"] call RE;
};
